// src/pages/Training/Algorithms/numbers/TrainingAlgorithmsNumber5.jsx
...
export default function TrainingAlgorithmsNumber5() {
  ...
  useEffect(() => {
    if (progress >= 100 && appState.isCollecting) {
      console.log("🛑 Progreso completado para '5', deteniendo recolección automáticamente.");
      stopCollecting();
    }
