// src/pages/Training/Algorithms/numbers/TrainingAlgorithmsNumber7.jsx
...
export default function TrainingAlgorithmsNumber7() {
  ...
  useEffect(() => {
    if (progress >= 100 && appState.isCollecting) {
      console.log("🛑 Progreso completado para '7', deteniendo recolección automáticamente.");
      stopCollecting();
    }
