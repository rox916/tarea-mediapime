// src/pages/Training/Algorithms/numbers/TrainingAlgorithmsNumber9.jsx
...
export default function TrainingAlgorithmsNumber9() {
  ...
  useEffect(() => {
    if (progress >= 100 && appState.isCollecting) {
      console.log("🛑 Progreso completado para '9', deteniendo recolección automáticamente.");
      stopCollecting();
    }
