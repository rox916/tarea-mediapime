// src/pages/Training/Algorithms/numbers/TrainingAlgorithmsNumber8.jsx
...
export default function TrainingAlgorithmsNumber8() {
  ...
  useEffect(() => {
    if (progress >= 100 && appState.isCollecting) {
      console.log("🛑 Progreso completado para '8', deteniendo recolección automáticamente.");
      stopCollecting();
    }
