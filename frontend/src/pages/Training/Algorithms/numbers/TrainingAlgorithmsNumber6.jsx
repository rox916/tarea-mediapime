// src/pages/Training/Algorithms/numbers/TrainingAlgorithmsNumber6.jsx
...
export default function TrainingAlgorithmsNumber6() {
  ...
  // Progreso actual del número 6
  const progress = appState.numberProgress?.[label]?.percentage || 0;

  // 🚨 Corte automático si llega al 100%
  useEffect(() => {
    if (progress >= 100 && appState.isCollecting) {
      console.log("🛑 Progreso completado para '6', deteniendo recolección automáticamente.");
      stopCollecting();
    }
